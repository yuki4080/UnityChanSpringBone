...
namespace Unity.Animations.SpringBones.Jobs
{
    ...
    public class BoneRendererInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Collect SpringBone")) {
                var bones = Object.FindObjectsOfType<SpringBone>();
                m_Transforms.ClearArray();
                for (int i = 0; i < bones.Length; ++i) {
                    m_Transforms.InsertArrayElementAtIndex(i);
                    m_Transforms.GetArrayElementAtIndex(i).objectReferenceValue = bones[i].transform;
                }
            }
